 ...
 * ─────────────────────────────────────────────────────────
 *  Remplace l'original php/partials/head.php
 *  Changement : require_once data/db.php au lieu de data/mock.php
 * ─────────────────────────────────────────────────────────
 */
$pageTitle = $pageTitle ?? 'ASINCO';
$bodyTheme = $bodyTheme ?? 'dark';

// ── Chargement Oracle (remplace mock.php) ─────────────────
...
<head>
  ...
  <script>
    window.addEventListener('DOMContentLoaded', function () {
      ...
      // Utilise le système de toast existant si disponible, sinon alert()
